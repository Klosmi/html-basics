...
```
*We can __add deifferent methods to the__ `Color` __prototype__: we define that method __outside of the constructor function__ (outside of the `function Color(r,g,b){...}`).*      
