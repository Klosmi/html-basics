...
- __[The `await` keyword](https://github.com/Klosmi/html-basics/blob/master/JS-basic.md#await-keyword)__ & __[error handling](https://github.com/Klosmi/html-basics/blob/master/JS-basic.md#error-handling-in-async-functions)__
...
So, this is how JavaScript knows where is it (like a bookmarker): what function is currently being run and what functions are called from within that function, etc.   
...
- __[API](https://github.com/Klosmi/html-basics/blob/master/JS-basic.md#api)__  
  ...
  __[HTTP response status codes]()__
