...
- eg.:  
    ...
    *This example is based on a random number (`Math.random`): where it imitates a `delay` which is between 500 ms - 4000 ms (if it's more than 4000 ms it's a failure, but shorter is a success).*
    ```
