...
In other words, JS keep track of the history of things that are waiting to be returned, so __which functions have been invoked but are not done yet__. Call Stack is the structure which stores that *(data structure)*.
