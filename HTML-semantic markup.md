...
- [`<article>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/article) :
  ...
  - eg.:   
    *Here `section`s are inside an article (they don't have a meaning alone). The article is about a soup recipe, and each section can describe deifferent parts of the recipe.* 
    ```
    <main>     
        <article>
          <h1>Onion soup</h1>
