...
14. [CSS - a simple trick: how to comepletely center an element in the page](https://github.com/Klosmi/html-basics/blob/master/CSS-center_an_element.md)
...
##### *I don't guarantee that it's perfect.*
##### *Several parts are gathered from different sites and courses, no intention to harm any copyrights. Web is open (or at least should be) free after all.* ;)
